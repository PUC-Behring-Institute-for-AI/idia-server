...
*Document version: 1.9 | Last updated: 2026-06-29 | Sections changed: §4.3 (LiteLLM rendering), §5.4 (compose healthcheck, DCGM), §5.6 (--render-all, dual render), §7.3 (SecurityGroupIds, worker_setup_commands), §16.7 (entry added)*